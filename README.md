<!--
  Two placeholders are still open — everything else is real content:
  - your.email@example.com  → your real email
  - linkedin.com/in/your-linkedin → your real LinkedIn URL
  Featured Projects link to real repos; add live-demo links if any of these
  projects are deployed.
  The contribution snake animation is generated by
  .github/workflows/snake.yml in this repo. It runs daily and on push to
  main, publishing to an `output` branch — no extra setup needed.
-->
...
### 🤖 SEO-Agent
**AI agent that audits websites, builds keyword databases, and analyzes competitors to generate SEO reports.**
...
### 🛒 Shoptelgram
**Serverless Telegram shop bot on Cloudflare Workers — catalog, cart, orders, and a full admin panel, near-zero cost.**
...
### 📊 WooCommerce Reports Pro
**WooCommerce analytics plugin with a scalable reporting architecture for sales and revenue insights.**
...
### 🧬 Persian Pedigree
**In-browser family tree app using medical genetics notation, built for genetic counseling and teaching.**
...
- 🤖&nbsp; Building out **[SEO-Agent](https://github.com/hoseinrza/SEO-Agent)** — an AI agent for automated site audits and SEO reporting
- 🛒&nbsp; Extending **[shoptelgram](https://github.com/hoseinrza/shoptelgram)** — a serverless Telegram commerce bot on Cloudflare Workers
- 🔗&nbsp; Designing clean, well-documented **REST APIs** with Node.js and Express
